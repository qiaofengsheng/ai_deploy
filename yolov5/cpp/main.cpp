...
int main(int argc, char const *argv[])
{
    ...
    std::string onnxPath = "/home/qfs/project/server_project/study/tensorrt/ai_deploy/yolov5/cpp/model/yolov5n.trt";
    std::string configPath = "/home/qfs/project/server_project/study/tensorrt/ai_deploy/yolov5/cpp/model/config.ini";
